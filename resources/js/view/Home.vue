        ...
        <div class="col-12 hero-text-image">
          <div class="row">
            ...
            <div class="col-lg-5 iphone-wrap">
              <img src="public/front/img/phone_1.png" alt="Image" class="phone-1" data-aos="fade-right">
              <img src="public/front/img/phone_2.png" alt="Image" class="phone-2" data-aos="fade-right" data-aos-delay="200">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row justify-content-center text-center mb-5" data-aos="fade">
          <div class="col-md-6 mb-5">
            <img src="public/front/img/undraw_svg_1.svg" alt="Image" class="img-fluid">
          </div>
        </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-6" data-aos="fade-left">
            <img src="public/front/img/undraw_svg_2.svg" alt="Image" class="img-fluid">
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-6" data-aos="fade-right">
            <img src="public/front/img/undraw_svg_3.svg" alt="Image" class="img-fluid">
          </div>
        </div>
      </div>
    </section>
          ...
          <div class="col-md-7">
            <div class="owl-carousel testimonial-carousel">
              <div class="review text-center">
                ...
                <p class="review-user">
                  <img src="public/front/img/person_1.jpg" alt="Image" class="img-fluid rounded-circle mb-3">
                  <span class="d-block">
              ...
              <div class="review text-center">
                ...
                <p class="review-user">
                  <img src="public/front/img/person_2.jpg" alt="Image" class="img-fluid rounded-circle mb-3">
                  <span class="d-block">
              ...
              <div class="review text-center">
                ...
                <p class="review-user">
                  <img src="public/front/img/person_3.jpg" alt="Image" class="img-fluid rounded-circle mb-3">
                  <span class="d-block">
