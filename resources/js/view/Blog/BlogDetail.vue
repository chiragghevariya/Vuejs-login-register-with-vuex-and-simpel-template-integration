      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 blog-content">
            ...
            <div class="row mb-5">
              <div class="col-md-6">
                <figure><img src="public/front/img/img_1.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid">
                  <figcaption>This is an image caption</figcaption>
                </figure>
              </div>
              <div class="col-md-6">
                <figure><img src="public/front/img/img_2.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid">
                  <figcaption>This is an image caption</figcaption>
                </figure>
              </div>
            </div>
          ...
          <div class="col-md-4 sidebar">
            ...
            <div class="sidebar-box">
              <img src="public/front/img/person_1.jpg" alt="Image placeholder" class="img-fluid mb-4">
...
<script>
    export default {
        name:"blog-detail",
        mounted() {
            console.log('Component mounted blog-detail.')
        }
    }
</script>