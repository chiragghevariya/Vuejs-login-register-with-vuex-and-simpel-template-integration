        ...
        <div class="row mb-5">
          <div class="col-md-4">
            <div class="post-entry">
              <router-link :to="{name:'BlogDetail',params:{slug:'abce'}}" class="d-block mb-4">
                <img src="public/front/img/img_1.jpg" alt="Image" class="img-fluid">
              </router-link>
              <div class="post-text">
          ...
          <div class="col-md-4">
            <div class="post-entry">
              <a href="blog-single.html" class="d-block mb-4">
                <img src="public/front/img/img_2.jpg" alt="Image" class="img-fluid">
              </a>
              <div class="post-text">
                <span class="post-meta">December 13, 2019 &bullet; By <a href="#">Admin</a></span>
                <h3><a href="#">Chrome now alerts you when someone steals your password</a></h3>
          ...
          <div class="col-md-4">
            <div class="post-entry">
              <a href="blog-single.html" class="d-block mb-4">
                <img src="public/front/img/img_3.jpg" alt="Image" class="img-fluid">
              </a>
              <div class="post-text">
                <span class="post-meta">December 13, 2019 &bullet; By <a href="#">Admin</a></span>
                <h3><a href="#">Chrome now alerts you when someone steals your password</a></h3>
          ...
          <div class="col-md-4">
            <div class="post-entry">
              <a href="blog-single.html" class="d-block mb-4">
                <img src="public/front/img/img_4.jpg" alt="Image" class="img-fluid">
              </a>
              <div class="post-text">
                <span class="post-meta">December 13, 2019 &bullet; By <a href="#">Admin</a></span>
                <h3><a href="#">Chrome now alerts you when someone steals your password</a></h3>
...
<script>
    export default {
        name:"blog-listing",
        mounted() {
            console.log('Component mounted blog-listing.')
        },
        metaInfo: {
            title: 'Blog',
